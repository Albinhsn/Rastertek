...
TextureShaderClass::TextureShaderClass() { m_OpenGLPtr = 0; }
...
void TextureShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                  char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool TextureShaderClass::SetShaderParameters(float *worldMatrix,
                                             float *viewMatrix,
