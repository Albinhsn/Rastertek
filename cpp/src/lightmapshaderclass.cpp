...
LightMapShaderClass::LightMapShaderClass() { m_OpenGLPtr = 0; }
...
bool LightMapShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/lightmap.vs");
  strcpy(psFilename, "./shaders/lightmap.ps");
...
void LightMapShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                   char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool LightMapShaderClass::SetShaderParameters(float *worldMatrix,
                                              float *viewMatrix,
