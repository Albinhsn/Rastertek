...
TransparentShaderClass::TransparentShaderClass() { m_OpenGLPtr = 0; }

TransparentShaderClass::TransparentShaderClass(
    const TransparentShaderClass &other) {}
...
bool TransparentShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/transparent.vs");
  strcpy(psFilename, "./shaders/transparent.ps");
...
bool TransparentShaderClass::InitializeShader(char *vsFilename,
                                              char *fsFilename) {
...
void TransparentShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                      char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool TransparentShaderClass::SetShaderParameters(float *worldMatrix,
                                                 float *viewMatrix,
