...
ClipPlaneShaderClass::ClipPlaneShaderClass() { m_OpenGLPtr = 0; }
...
bool ClipPlaneShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/clipplane.vs");
  strcpy(psFilename, "./shaders/clipplane.ps");
...
bool ClipPlaneShaderClass::InitializeShader(char *vsFilename,
                                            char *fsFilename) {
  ...
  if (!fragmentShaderBuffer) {
    printf("ERROR: Failed to load fragment shader '%s'\n", fsFilename);
    return false;
  }
...
void ClipPlaneShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                    char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool ClipPlaneShaderClass::SetShaderParameters(float *worldMatrix,
                                               float *viewMatrix,
