...
ParticleShaderClass::ParticleShaderClass() { m_OpenGLPtr = 0; }
...
bool ParticleShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/particle.vs");
  strcpy(psFilename, "./shaders/particle.ps");
...
void ParticleShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                   char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool ParticleShaderClass::SetShaderParameters(float *worldMatrix,
                                              float *viewMatrix,
