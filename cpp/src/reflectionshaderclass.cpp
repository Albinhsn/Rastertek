...
ReflectionShaderClass::ReflectionShaderClass(
    const ReflectionShaderClass &other) {}
ReflectionShaderClass::~ReflectionShaderClass() {}
...
bool ReflectionShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/reflection.vs");
  strcpy(psFilename, "./shaders/reflection.ps");
...
bool ReflectionShaderClass::InitializeShader(char *vsFilename,
                                             char *fsFilename) {
...
void ReflectionShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                     char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool ReflectionShaderClass::SetShaderParameters(float *worldMatrix,
                                                float *viewMatrix,
  ...
  // Set the texture in the pixel shader to use the data from the first
  // texture unit.
  location =
  ...
  // Set the texture in the pixel shader to use the data from the second
  // texture unit.
  location =
