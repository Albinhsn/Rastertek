...
bool ModelClass::Initialize(OpenGLClass *OpenGL, char *modelFilename,
                            char *textureFilename1, bool wrap1,
                            char *textureFilename2, bool wrap2,
...
bool ModelClass::LoadTextures(char *textureFilename1, bool wrap1,
                              char *textureFilename2, bool wrap2,
                              char *textureFilename3, bool wrap3) {
  bool result;
  ...
  result = m_Textures[0].Initialize(m_OpenGLPtr, textureFilename1, 0, wrap1);
  if (!result) {
    return false;
  }

  result = m_Textures[1].Initialize(m_OpenGLPtr, textureFilename2, 1, wrap2);
  if (!result) {
    return false;
  }

  result = m_Textures[2].Initialize(m_OpenGLPtr, textureFilename3, 2, wrap3);
  if (!result) {
    return false;
  }
