...
RefractionShaderClass::RefractionShaderClass() { m_OpenGLPtr = 0; }

RefractionShaderClass::RefractionShaderClass(
    const RefractionShaderClass &other) {}
...
bool RefractionShaderClass::Initialize(OpenGLClass *OpenGL) {
  ...
  strcpy(vsFilename, "./shaders/refraction.vs");
  strcpy(psFilename, "./shaders/refraction.ps");
...
bool RefractionShaderClass::InitializeShader(char *vsFilename,
                                             char *fsFilename) {
...
void RefractionShaderClass::OutputShaderErrorMessage(unsigned int shaderId,
                                                     char *shaderFilename) {
  long count;
  int logSize, error;
  char *infoLog;
...
bool RefractionShaderClass::SetShaderParameters(
